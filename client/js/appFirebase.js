  ...
  var config = {
    ...
    messagingSenderId: "G-BZQDYQBTYN"
  };
...
function llenarDatos() {
  ...
  db.ref('/btc').once('value').then(function(d) {
    btcInfoArreglo = Object.values(d.val());
  ...
  db.ref('/eth').once('value').then(function(d) {
    ethInfoArreglo = Object.values(d.val());
    ethInfoObjeto = d;
  ...
  db.ref('/brentoil').once('value').then(function(d) {
    brentInfoArreglo = Object.values(d.val());
    brentInfoObjeto = d;
